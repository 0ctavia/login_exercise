...
<input type="text" name="regusername" id="username">
<span class="error"><?php echo $usernameErr ?></span>
<label for="useremail">Your email</label>
<input type="email" placeholder="Your email" name="regemail" id="useremail">
<span class="error"><?php echo $emailErr ?></span>
<label for="userpassword">Your password</label>
<input type="password" name="regpassword" id="userpassword">
<span class="error"><?php echo $passwordErr ?></span>
<label for="firstname">Your first name</label>
<input type="text" name="regfirstname" id="firstname">
<span class="error"><?php echo $firstnameErr ?></span>
<label for="lastname">Your last name</label>
<input type="text" name="reglastname" id="lastname">
<span class="error"><?php echo $lastnameErr ?></span>
<label for="userlinkedin">Your Linkedin</label>
<input type="url" name="reglinkedin" id="userlinkedin">
<label for="usergithub">Your Github</label>
<input type="url" name="reggithub" id="usergithub">
